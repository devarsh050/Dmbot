token = "NjM4NjU0MzU5NDIwNDAzNzEy.Xcbm8w.5c0MaevZiBqHUzOLH4vIeCjaD2o" #You get that from the discord developer portal
...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Activity(name='FreeFire' , type=0))
